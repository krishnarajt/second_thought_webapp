  ...
  return (
    <div className="p-6 overflow-auto">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Top Section - Profile & Schedule (2 cols on large screens) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          ...
          <button
            ...
            className="py-3 bg-indigo-500 text-white rounded-lg font-medium hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center"
          >
            {isLoading ? (
          ...
          <button
            onClick={onLogout}
            className="py-3 border border-red-500 text-red-500 rounded-lg font-medium hover:bg-red-50 transition flex items-center justify-center gap-2"
          >
            <span>🚪</span>
            Log Out
          </button>
